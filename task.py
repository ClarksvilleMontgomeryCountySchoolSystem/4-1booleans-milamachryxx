...
# The variables which were easiest to work with were
# the ones that straight up said what it was rather
# than what it was not. These were easier because I
# found it easier to process when the variable was
# named to be what it is than what it isn't. When
# it's something it's not it causes me to trip over
# my thoughts and second guess.
# Which were most confusing? Why?
# The questions which asked what thing are not but
# the hardest thing for me was when I was asked both
# a "not" question and given direction that wasn't
# worded the same I had a harder time understanding
# because you have to think about how the statement
# given relates to a question.
